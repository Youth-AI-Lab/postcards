# FARO · An Italian postcard from Perlatecnica — Postcard text

All copy on the postcard, ready for rewriting.
Path: `SuccessStories/postcards/italy/faro-postcard-01/index.html`

---

## Page title (browser tab)

> FARO · An Italian postcard from Perlatecnica
> 
...
- Stamp avatar: Cornicello (SVG, Neapolitan good-luck horn)
- Stamp logo: Perlatecnica (file: `logo.png`)
- Postmark: **Napoli**, 18 / 06 / 2026
...
## Fiche 01 · Feb 2026 · accent pink

**Title:** Keep an Eye on AI · spotting AI in everyday life.
...
- PPT, observation sheets, group detectives · 2h30
...
## Fiche 02 · Mar 2026 · accent blue

**Title:** Illusion is all that matters · LLM limits, robotics and SDGs.
...
- LLM paper, Otto robot, SDG mapping, RL analogy · 2h30
...
## Fiche 03 · Apr 2026 · accent orange

**Title:** BIAS, Genre Matters · catching the AI on assumptions.
...
**Activity:**
- BIAS, Genre Matters
- SDG 5, LLM probing, binary classifier · 2h30
...
- Title: **Still to come**
- Label: `Ten workshops on the calendar`

### Dates (exact, full DD/MM/YYYY format on the spots)
...
## Data to verify with the FARO team

- Exact participant count per session and total unique youth (current stat: 23, approximated from the Keep an Eye on AI participant list).
- Age range of the explorers.
- Number of explorers in each session.
- All sessions have been reported.
- Pictures missing.